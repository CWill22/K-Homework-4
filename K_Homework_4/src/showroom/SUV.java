...
class SUV extends Vehicle {
    public SUV(String brand, String make, long modelYear, double price, VehicleColor color, FuelType fuelType, double mileage, int cylinders, double gasTankCapacity) {
    ...
    public void startEngine(){
        if (this.getStartType() == StartMechanism.PUSHSTART){
